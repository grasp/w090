...
describe Rforum::Cpanel::CommentsController do
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested comment" do
        Rforum::Comment.any_instance.should_receive(:update_attributes).with({'body' => 'params'})
    ...
    describe "with invalid params" do
      it "assigns the comment as @comment" do
        Rforum::Comment.any_instance.stub(:save).and_return(false)
  ...
  describe "DELETE destroy" do
    it "destroys the requested comment" do
      ...
      }.to change(Rforum::Comment, :count).by(-1)
    end
