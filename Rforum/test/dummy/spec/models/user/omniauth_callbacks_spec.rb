...
describe Ruser::User::OmniauthCallbacks do
  let(:callback) { Class.new.extend(Ruser::User::OmniauthCallbacks) }
  ...
  describe "new_from_provider_data" do
    ...
    it "should create a new user" do
      callback.new_from_provider_data(nil, nil, data).should be_a(Ruser::User)
    end
