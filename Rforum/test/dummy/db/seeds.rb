...
# Wiki 首页 HTML
Rforum::SiteConfig.save_default("wiki_index_html",<<-eos
<div class="box">
  Wiki Home page.
</div>
eos
...
# 话题后面的HTML代码
Rforum::SiteConfig.save_default("after_topic_html",<<-eos
  <!--
...
# 话题正文前面的HTML
Rforum::SiteConfig.save_default("before_topic_html",<<-eos
eos
)

# 话题列表首页边栏HTML
Rforum::SiteConfig.save_default("topic_index_sidebar_html",<<-eos
<div class="box">
  <h2>公告</h2>
  <div class="content">
    Hello world.
...
<div class="box">
  <h2>置顶话题</h2>
  <ul class="content">
    <li><a href="/rforum/topics/1">Foo bar</a></li>
  </ul>
</div>
eos
)
...
# 酷站列表首页头的HTML
Rforum::SiteConfig.save_default("site_index_html",<<-eos
