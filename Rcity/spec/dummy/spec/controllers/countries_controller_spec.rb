...
describe Rcity::CountriesController do ###
  ...
  describe "GET index" do
    it "assigns all countries as @countries" do
      country =Rcity::Country.create! valid_attributes
      get :index, {}, valid_session
     # assigns(:countries).should eq([country])
     # assigns(:countries).should have_many :countries
  ...
  describe "GET new" do
    it "assigns a new country as @country" do
      ...
      assigns(:country).should be_a_new(Rcity::Country)
    end
  end
  ...
  #    assigns(:country).should eq(Rcity::Country)
   assigns(:country).should eq(country)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Country" do
        ...
        }.to change(Rcity::Country, :count).by(1)
      end

      it "assigns a newly created country as @country" do
        post :create, {:country => valid_attributes}, valid_session
      assigns(:country).should be_a(Rcity::Country)
        assigns(:country).should be_persisted
      end

      it "redirects to the created country" do
        post :create, {:country => valid_attributes}, valid_session
        response.should redirect_to(Rcity::Country.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved country as @country" do
        ...
        Rcity::Country.any_instance.stub(:save).and_return(false)
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the countries list" do
      country =Rcity::Country.create! valid_attributes
      delete :destroy, {:id => country.to_param}, valid_session
      response.should redirect_to(countries_url(:only_path=>true)) #using relative path
    end
  end
