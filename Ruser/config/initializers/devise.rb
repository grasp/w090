...
Devise.setup do |config|
 ...
 config.mailer_sender = "change_yous@email.com"
#config.default_url_options[:host]="http://w090.com"
 ...
 #!!!!! config.omniauth :github, Setting.github_token, Setting.github_secret #by hunter change,comments at first
